...
$MESS['FIELD_EMPLOYEE'] = 'Ф.И.О. сотрудника';
$MESS['FIELD_STATUS'] = 'Статус';
$MESS['FIELD_DEPARTMENT'] = 'Подразделение';
...
$MESS['ERROR_PHONE'] = 'Укажите номер телефона';
$MESS['ERROR_WORKPLACE'] = 'Укажите место работы';
