...
<div class="container-fluid">
    ...
    <ul>
        <li>
            ...
            <br><a href="http://bitrix.localhost/bitrix/admin/iblock_list_admin.php?IBLOCK_ID=21&type=lists&lang=ru&find_section_section=0&SECTION_ID=0&apply_filter=Y&find_section_section=0" target="_blank">Инфоблок заявки</a>
        </li>
        <li>
            ...
            <br>Активити: <a href="http://bitrix.localhost/bitrix/admin/fileman_admin.php?PAGEN_1=1&SIZEN_1=20&lang=ru&site=s1&path=%2Flocal%2Factivities%2Fcustom%2Fgetdadataorgbyinnactivity&show_perms_for=0&fu_action=" target="_blank">getdadataorgbyinnactivity.php</a>
        </li>
    </ul>
</div>
