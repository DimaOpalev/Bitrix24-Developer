...
CONST HANDLER = 'https://cv174341.tw1.ru/otus/students_dz/homework11/handler.php';
...
if($result['rest_only'] === false):?>
    ...
    <body>
        <?php
            var_dump($contactEvent, $commentEvent, $activityEvent);
        ?>
...
file_put_contents(__DIR__ . '/raw_debug.log', date('H:i:s') . " - " . ob_get_contents() . "\n", FILE_APPEND);

ob_end_flush(); // Отправляет данные пользователю и закрывает буфер
